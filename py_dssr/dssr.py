...
from py_dssr import dssr_classes, settings
...
class DSSROutput(object):
    def __init__(self, pdb_path):
        ...
        self.__nts : Dict[dssr_classes.DSSR_NT] = None
        self.__pairs : Dict[dssr_classes.DSSR_PAIR] = None
    ...
    # getters
    def get_nts(self) -> Dict[dssr_classes.DSSR_NT]:
    ...
    def get_pairs(self) -> Dict[dssr_classes.DSSR_PAIR]:
    ...
    def get_hbonds(self) -> List[dssr_classes.DSSR_HBOND]:
        ...
        self.__splay_units = self.__populate_attribute("hbonds", dssr_classes.DSSR_HBOND)
